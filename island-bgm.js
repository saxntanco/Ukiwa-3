...
function openPage(url,push=true){
 ...
 if(!frame){
  ...
  dock.style.gap='8px';dock.style.padding='8px';dock.querySelectorAll('button').forEach(b=>b.style.cssText='flex:0 0 auto;white-space:nowrap;border:1px solid #68818d;border-radius:8px;background:#244350;color:#fff;padding:8px;font-size:12px');dock.querySelector('label').style.cssText='flex:0 0 80px;font-size:11px';dock.querySelector('a').style.cssText='flex:1;min-width:0;color:#c9efff;font-size:10px';
