...
bgm.hidden=true;document.body.append(bgm);bgm.loop=true;bgm.preload='none';bgm.volume=.24;
let context:AudioContext|undefined;
export let effects=true;
export function toggleEffects(){effects=!effects}
export async function music(){if(!bgm.paused){bgm.pause();return}await bgm.play()}
